...
/*
 NOTE: Ideas
- Use combos (two keys at once) to utilize ,.ß¨
*/

// Define the keymap using LAYOUT_split_3x5_3
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(                                                                                                                            // Colemak letters
        KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, MT(MOD_LGUI, DE_COLN),                                                                     // first row
        KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O,                                                                                      // second row
        KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_DOT, KC_COMM, MT(MOD_RALT, DE_SCLN),                                                                // third row
    ...
    [3] = LAYOUT_split_3x5_3(                                                                                                                            // Mouse and Arrows
        ...
        TO(0), KC_BSPC, KC_NO, KC_NO, KC_SPC, TO(4)                                                                                                      // thumb keys
    ),                                                                                                                                                   //
    [4] = LAYOUT_split_3x5_3(                                                                                                                            // Function keys and media control
        ...
        TO(0), KC_BSPC, KC_NO, KC_NO, KC_SPC, TO(5)                                                                                                      // thumb keys
    ),                                                                                                                                                   //
    [5] = LAYOUT_split_3x5_3(                                                                                                                            // Settings
        ...
        TO(0), KC_BSPC, KC_NO, KC_NO, KC_SPC, KC_NO                                                                                                      // thumb keys
    ),                                                                                                                                                   //
    [6] = LAYOUT_split_3x5_3(                                                                                                                            // QWERTY letters
        ...
        KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_DOT, KC_COMM, DE_SS,                                                                                // third row
        TD(TD_SHIFT_CAPS), KC_BSPC, K_LAYER1, K_LAYER2, KC_SPC, K_CTRL                                                                                   // thumb keys
    ),                                                                                                                                                   //
};
